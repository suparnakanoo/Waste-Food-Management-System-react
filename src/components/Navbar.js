        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu">
              <li><a className="dropdown-item" href="/">{props.spFirstPart} </a></li>
              <li><a className="dropdown-item" href="/">{props.spSecondPart}</a></li>
            </ul>
          </li>
          <li className="nav-item">
...
Navbar.propTypes={
    ...
    spFirstPart: PropTypes.string,
    spSecondPart: PropTypes.string,
...
Navbar.defaultProps ={
  ...
  spFirstPart: 'part one',
  spSecondPart: 'part two',
